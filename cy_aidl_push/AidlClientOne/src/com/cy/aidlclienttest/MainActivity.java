...
import com.cy.aidlclientonetest.R;
...
public class MainActivity extends Activity {
    ...
    public void getServerData(View view) {
        try {
            /**
             * 如果两个应用设置成了同一个sharedUserId，可以通过这种方式获取到应用2中的资源，包括：数据库，preference，资源文件等等
             */
            Context otherContext = this.createPackageContext("com.cy.aidlserveronetest",Context.CONTEXT_IGNORE_SECURITY);
            Log.e("cyTest", "otherContext.getPackageName() : "+otherContext.getPackageName());
            String value = null;
            SharedPreferences preferences = otherContext.getSharedPreferences("com.cy.aidlserveronetest", Context.MODE_PRIVATE);
            if (null != preferences) {
                value = preferences.getString("test", null);
            }
            Log.e("cyTest", "value : "+value);
