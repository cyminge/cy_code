...
//import com.veclink.tracker.util.Constant;
 ...
 * @version $Rev: 689337 $, $Date: 2008-08-27 04:18:17 +0200 (Wed, 27 Aug 2008) $
 * @org.apache.xbean.XBean
 */
public class KeepAliveFilter extends IoFilterAdapter {

	// modify by zhanmin
	public static final AttributeKey WAITING_FOR_RESPONSE = new AttributeKey(
    		KeepAliveFilter.class, "waitingForResponse");
    public static final AttributeKey IGNORE_READER_IDLE_ONCE = new AttributeKey(
    		KeepAliveFilter.class, "ignoreReaderIdleOnce");
...
//            getClass(), "ignoreReaderIdleOnce");
    ...
    /**
     * modify by zhanmin 20140802 解决isResponse方法调用两次的问题
     */
    @Override
    public void messageReceived(
        ...
        try {
        	isRequest = messageFactory.isRequest(session, message);
            if (isRequest) {
                Object pongMessage =
            ...
            isResponse = messageFactory.isResponse(session, message);
            if (isResponse) {
                resetStatus(session);
            }
        } finally {
...
//		Tracer.appendSimpleLog('d', "MinaTcpClientThread", "handlePingTimeout ! 时间 = "+StringUtil.formatCurrDate(Constant.TIMEFORMAT));
